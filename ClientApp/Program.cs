...
namespace ClientApp
{
    class Program
    {
        ...
        static void ListAllProducts()
        {
            ...
            var products = resp.Content.ReadAsAsync<IEnumerable<SelfHostRestConsole.Product>>().Result;
        ...
        static void ListProduct(int id)
        {
            ...
            var product = resp.Content.ReadAsAsync<SelfHostRestConsole.Product>().Result;
